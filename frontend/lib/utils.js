...
async function getUserItems(searchParam){
    //return fetch(`http://35.245.126.165/api/usersearch?q=${foodname}`).then(function(resp) {
...
async function getItems(searchParam){
    //return fetch(`http://35.245.126.165/api/search?q=${foodname}`).then(function(resp) {
